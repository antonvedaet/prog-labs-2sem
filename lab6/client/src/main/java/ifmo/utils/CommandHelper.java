...
public class CommandHelper implements Serializable {
    ...
    public static HashMap<String, Command> argCheckMap(){
        ...
        map.put("count_less_than_height", new CountLessThanHeight());
        map.put("filter_contains_name", new FilterContainsName());
        map.put("group_counting_by_id", new GroupCountingById());
